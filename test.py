...
class DriveToQdrantApp:
    def __init__(self):
        ...
        self.window.geometry("400x400")  # Adjusted height for extra fields
    ...
    def create_ui(self):
        ...
        # Qdrant URL label and entry
        qdrant_url_label = ttk.Label(main_frame, text="Qdrant URL:")
        qdrant_url_label.pack(pady=(0, 5))
        self.qdrant_url_entry = ttk.Entry(main_frame, width=30)
        self.qdrant_url_entry.pack(pady=(0, 20))
        
        # Qdrant API Key label and entry
        qdrant_api_key_label = ttk.Label(main_frame, text="Qdrant API Key:")
        qdrant_api_key_label.pack(pady=(0, 5))
        self.qdrant_api_key_entry = ttk.Entry(main_frame, width=30, show='*')
        self.qdrant_api_key_entry.pack(pady=(0, 20))
    ...
    def handle_sync(self):
        ...
        qdrant_url = self.qdrant_url_entry.get().strip()
        ...
        if not qdrant_url or not qdrant_api_key or not collection_name:
            messagebox.showerror("Error", "Please enter Qdrant URL, API Key, and Collection Name.")
            return
        
        # Initialize Qdrant client with user input
